 ...
 * Library: **core**  
 *   
 * *This enum duplicate values from: `Pixi.ALPHA_MODES` for more convenience.*
 */
enum abstract AlphaMode(Int) to Int from Int
{
    /**
     * Source is not premultiplied, leave it like that.  
     * Option for compressed and data textures that are created
     * from typed arrays.
     */
    var NO_PREMULTIPLIED_ALPHA = 0;

    /**
     * Source is not premultiplied, premultiply on upload. Default
     * option, used for all loaded images.
     */
